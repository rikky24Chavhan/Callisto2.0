...
final class DashboardTableViewCell: UITableViewCell {
    ...
    static var imageDownloader: ImageDownloader = {
        // Prevent image inflating from JPEG to bitmap, causing memory issues on older devices
        let imageDownloader = ImageDownloader()
        imageDownloader.imageResponseSerializer = DataRequest.imageResponseSerializer(inflateResponseImage: false)
