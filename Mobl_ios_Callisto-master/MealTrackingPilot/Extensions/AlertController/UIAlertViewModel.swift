...
public final class UIAlertViewModel {
    ...
    private(set) var preferredStyle: UIAlertControllerStyle
    private(set) var actionViewModels: [UIAlertActionViewModel]

    init(title: String?, message: String?, preferredStyle: UIAlertControllerStyle, actionViewModels: [UIAlertActionViewModel]) {
        self.title = title
