...
final class MealEventDetailsViewModel: MealEventNotesEntryViewModelDelegate {
    ...
    var canEditMeal: Bool {
        return Date() < mealEvent.date.adjustDays(noOfDays: 2)
    }
    ...
    var logButtonAttributedString: NSAttributedString {
        ...
        case .create:
            ...
            attributedString.addAttributes(
                [
                    NSAttributedString.Key.font : UIFont.openSansSemiboldFont(size: 18),
        ...
        case .edit:
            if canEditMeal {
                ...
                attributedString.addAttributes(
                    [
                        NSAttributedString.Key.font : UIFont.openSansSemiboldFont(size: 20),
                        NSAttributedString.Key.foregroundColor : UIColor.white
                    ],
                    range: NSMakeRange(0, attributedString.string.count)
                )
                ...
                attributedString.addAttributes(
                    [
                        NSAttributedString.Key.font : UIFont.openSansItalicFont(size: 16),
                        NSAttributedString.Key.foregroundColor : UIColor.white
                    ],
                    range: NSMakeRange(0, attributedString.string.count)
                )
    ...
    private func format(date: Date) -> NSAttributedString {
        ...
        let boldAttributes = [
            NSAttributedString.Key.font : UIFont.openSansSemiboldFont(size: 33),
            NSAttributedString.Key.foregroundColor : formattedDateTextColor
        ]
        let lightAttributes = [
            NSAttributedString.Key.font : UIFont.openSansLightFont(size: 33),
            NSAttributedString.Key.foregroundColor : formattedDateTextColor
        ]
