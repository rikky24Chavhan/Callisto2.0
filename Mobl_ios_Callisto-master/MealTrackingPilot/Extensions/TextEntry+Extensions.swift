...
public extension UITextField {
    public func configureCustomReturnButton(withImage image: UIImage = #imageLiteral(resourceName: "checkWithWhiteBackground"), disclaimerText: String? = nil) {
...
public extension UITextView {
    ...
    public var customReturnButtonAccessoryViewHeight: CGFloat {
