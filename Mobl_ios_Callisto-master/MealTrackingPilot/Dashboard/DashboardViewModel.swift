...
public class DashboardViewModel: ReportMealEventViewModelDelegate {
    ...
    private var previousDayMealEventCount: Observable<Int> {
        ...
        let previousStartOfDay = startOfDay - 1.day
    ...
    fileprivate static func applyLogMessageStyle(to message: String, boldRange: NSRange? = nil) -> NSAttributedString {
        ...
        attributedString.addAttributes(
            [
                NSAttributedStringKey.font : UIFont.openSansLightFont(size: fontSize),
                NSAttributedStringKey.foregroundColor : UIColor.piWhite
            ],
        ...
        if let boldRange = boldRange {
            attributedString.addAttributes(
                [
                    NSAttributedStringKey.font : UIFont.openSansFont(size: fontSize),
                    NSAttributedStringKey.foregroundColor : UIColor.piWhite
                ],
                range: boldRange
            )
    ...
    fileprivate static func applySuggestionMessageStyle(to message: String) -> NSAttributedString {
        return NSAttributedString(
            string: message,
            attributes: [
                NSAttributedStringKey.font : UIFont.openSansSemiboldFont(size: UIDevice.current.isSmallHeight ? 14 : 16),
